...
class ControllerDownloadFileDownload extends Controller {
  ...
  public function index() {
    ...
    $file = $this->inputest->trimTitle( preg_replace( '#[^-\w]#', '', $this->request->post['file'] ) );
    ...
    if( is_array($download_allowed) ) {
      ...
      $output = array('status' => 401, 'error' => 'File is not allowed to download to you!');
  ...
  public function allowDownload( $data ) {
    ...
    */
    ...
    if( $download_hook['download'] == TRUE ) {
      ...
      $output = array('status' => 404, 'error' => 'We could\'t found file!');
      echo json_encode($output);
    }
  }
