    ...
    <div class="s_c_e_containner"style="max-width: 800px;width: auto;height: auto;background-color: #eee;margin: 0 auto;">
      <div class="s_c_e_header"style="width: 100%;background-color: #252830;height: 70px;">
        <div class="s_c_e_header_inn"style="width: 80%;margin: 0 auto;">
          ...
          <h1 class="s_c_e_lg fl_l"style="font-size: 22px;color: #fff;float: left;font-family: arial;font-weight: inherit;padding: 22px 0px;">NoticeMate</h1>
        </div>
      </div>
      <div class="s_c_e_content"style="width: 80%;height:auto;margin: 0 auto;">
        ...
        <p class="s_c_e_c_text"style="font-size: 15px;color: #252830;font-family: arial;padding: 0px 10px;font-weight: 200;line-height: 20px;">Someone has requested password reset on <b>noticemate.com</b> using your email address.<br>If this is not you then please ignore this email, otherwise click the below button and reset your password. </p>
        <a href="http://web.noticemate.com/?mod=pass_reset&token=<?php echo $data['ver_code'] . "&email=" . $data['email']; ?>">
          <button class="s_c_e_btn"style="width: 50%;padding: 10px;color: #fff;background-color: #2196F3;border:none;margin: 20px 0px 30px 5px;font-size: 17px; border-radius: 5px; cursor: pointer;">Reset Password</button></a>
