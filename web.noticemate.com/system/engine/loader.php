...
final class Loader {
  ...
  public function controller($route, $data = array()) {
    ...
    //directory to go
    if( isset($data['dir']) && $data['dir'] == 'androidapi' )
      $controller_dir = USER_DIR . '/apicontroller/android';
    else
      $controller_dir = USER_DIR . '/controller';

    // Break apart the route
    while ($parts) {
      $file = $controller_dir . '/' . implode('/', $parts) . '.php';
  ...
  public function view($template, $data = array()) {
    ...
    if( isset($view_dir) && $view_dir === true ) {
      $file = USER_VIEW_DIR . $template;
    } else $file = APP_DIR . $template;
